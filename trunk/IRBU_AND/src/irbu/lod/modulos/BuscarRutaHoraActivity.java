...
public class BuscarRutaHoraActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TimePicker pn = (TimePicker) findViewById(R.id.tpHora);
	...
	/*
	 * Hace el llamado de la lista de rutas dependiendo de la opción escogida
	...
	private void buscarListaRutas() {
		...
		regresar.putExtra("hora", hora.getCurrentHour()+":"+hora.getCurrentMinute());
		startActivity(regresar);
	}
